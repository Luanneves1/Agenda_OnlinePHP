...
<div class="row">
    ...
    <div class=" col-6">
        <form class="needs-validation" action="index.php?menuop=atualizarContato" method="post" novalidate>
            ...
            <div class="row">
                ...
                <div class="mb-3 col-6">
                    <label class="form-label" for="dataNascimentoContato">Data de Nascimento</label required>
                    <div class="input-group">
                        <span class="input-group-text"><i class="bi bi-calendar-date"></i></span>
                        <input class="input-group-text" type="date" name="dataNascimentoContato" value="<?= $dados["dataNascimentoContato"] ?>">
                    </div>
                </div>
            ...
            <div class="mb-3">
                <input class="btn btn-warning mb-3 class=" form-control type="submit" value="Atualizar" name="btnAtualizar">
            </div>
        </form>
    </div>
    ...
    <div class="col-6">
        <?php
        if ($dados["nomeFotoContato"] == "" || !file_exists('./paginas/contatos/fotos-contato/' . $dados["nomeFotoContato"])) {
        ...
        ?>
        <div class="col-6 img-fluid "> <img width="500" class=" rounded-circle " src="./paginas/contatos/fotos-contato/<?= $nomeFoto ?>" alt="Foto Contato">
        </div>

        <div class="mb-3">
            <button class="btn btn-warning" id="bnt_editar_foto"><i class="bi bi-camera2"> Editar Foto</i></button>
        </div>
